...
--Assignment: Assignment2-definition.sql
--Due Date: 2/14/16
...
(
	...
	dob DATE,
	date_joined DATE,
	CONSTRAINT employee_unique UNIQUE (first_name, last_name)
);
...
VALUES ('Sara','Smith','1970/1/2');

INSERT INTO client (first_name, last_name, dob)
VALUES ('David','Atkins','1979/11/18');

INSERT INTO client (first_name, last_name, dob)
VALUES ('Daniel','Jensen','1985/3/2');
...
VALUES ('Adam','Lowd','1975/1/2','2009/1/1');

INSERT INTO employee (first_name, last_name, dob,date_joined)
VALUES ('Michael','Fern','1980/10/18','2013/6/5');

INSERT INTO employee (first_name, last_name, dob,date_joined)
VALUES ('Deena','Young','1984/3/21','2013/11/10');
